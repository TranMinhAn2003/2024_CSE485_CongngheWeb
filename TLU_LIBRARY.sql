...
-- Dumping data for table tlu_library.authors: ~0 rows (approximately)
...
-- Dumping data for table tlu_library.books: ~0 rows (approximately)
INSERT INTO `books` (`id`, `title`, `author`, `description`, `genre`) VALUES
	...
	(3, 'The Hitchhiker\'s Guide to the Galaxy', 'Douglas Adams', 'A humorous science\r\nfiction comedy...', 'Science Fiction');
...
-- Dumping data for table tlu_library.books_authors: ~0 rows (approximately)
